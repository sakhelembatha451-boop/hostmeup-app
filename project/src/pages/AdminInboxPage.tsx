...
import { Loader2, Send, MessageSquare, X, Calendar, User, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-paper">
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-12">
        <div className="mb-10">
          ...
          <h1 className="font-display text-4xl font-bold text-ink tracking-tight">Admin Inbox</h1>
          <p className="text-ink-400 mt-1">All user conversations and booking discussions.</p>
        </div>
